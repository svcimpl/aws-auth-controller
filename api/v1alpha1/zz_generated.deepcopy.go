...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AWSAuthStatus) DeepCopyInto(out *AWSAuthStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSAuthStatus.
func (in *AWSAuthStatus) DeepCopy() *AWSAuthStatus {
	if in == nil {
		return nil
	}
	out := new(AWSAuthStatus)
	in.DeepCopyInto(out)
	return out
}
